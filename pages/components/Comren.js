...
const Comren = () => {
  return (
    <div className={styles.comren_container}>
      <h1 className={styles.comren_heading}>COMREN NETWORK</h1>
      ...
      <div className={styles.content_container + " row"}>
        <div className={styles.comren_content + " col-lg-8"}>
          <p>
            CRDIG is a founding member of the Canadian Hydrographic Research and Education Network
            (RéCREH / COMREN).
          </p>
          <p>
            This network aims to develop research activities, achieve technology transfer, develop
          ...
          {Object.keys(COMRENMEMBERS).map((k, index) => {
            ...
            return (
              <li key={index} className={styles.comren_mem_list}>
                <a className={styles.comren_mem_tsext} href={COMRENMEMBERS[k].univ_url}>
